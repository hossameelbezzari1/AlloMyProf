<?php
    ...
    if(!GetStatuChangePassword($_COOKIE['id_reset'])){
        // echo 'redirect';
        header('Location: reset');
        exit();
    }
...
<body>
            ...
            <div class="col-10 col-xs-6 col-md-5 col-lg-4">
                <form class="formLogin" action="" id="login" method="post">
                    ...
                    <div class="LineLog">
                        ...
                        <input class="uind" required type="text" name="password1">
                        <p>Re-Write a new password</p>
                        <input required type="text" name="password2">
                    </div>
                    <div id="success" ></div>
                    <button type="submit" class="btnLogin">Change Password</button>
    ...
    <script >
        $(document).on('submit','#login',function(e){
            ...
            $.ajax({
                type:'POST',
                url:'includes/check/check_changePassword.php',
                beforeSend:function(){
