...
<body class="">
          ...
          <div class="row">
                ...
                <div class="card-body">
                  <form action="" method="post" id="login" role="form">
                    ...
                    <div class="text-center">
                      <button type="ssubmit" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button>
                    </div>
                    <div id="success"></div>
                  </form>
                </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('assets/images/material/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            ...
            </script> Soft by Hossame El Bezzari
          </p>
        </div>
      </div>
    </div>
  ...
  <script >
        $(document).on('submit','#login',function(e){
            ...
            $.ajax({
                type:'POST',
                url:'dashboard/includes/check/check_login.php',
                beforeSend:function(){
