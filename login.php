...
<body>
        ...
        <div class="row align-items-center justify-content-center align-self-center">
            <div class="col-10 col-xs-6 col-md-5 col-lg-4">
                <form class="formLogin" action="" id="login" method="post">
                    ...
                    <div class="LineLog">
                        <p><?php echo Text('Emailaddress');?></p>
                    ...
                    <div id="success" ></div>
                    <button type="submit" class="btnLogin"><?php echo Text('login');?></button>
                    <div><a class="resetPass" href="reset"><?php echo Text('Forgotyourpassword');?></a></div>
                    <a class="resetPass" href="signup"><?= Text('Idonthaveanaccount');?> <span> , <?= Text('createone');?></span></a>
                    <!-- <div class="orUser">
                        <div class="lll"></div>
    ...
    <script >
        $(document).on('submit','#login',function(e){
            ...
            $.ajax({
                type:'POST',
                url:'includes/check/check_login.php',
                beforeSend:function(){
