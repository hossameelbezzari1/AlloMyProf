<?php
    ...
    if(isset($_POST['btncontact'])){
        if(!empty($_POST['name']) and !empty($_POST['email']) and !empty($_POST['subject']) and !empty($_POST['message'])){
            SetSupport(filter_var($_POST['name'],FILTER_SANITIZE_STRING),filter_var($_POST['email'],FILTER_SANITIZE_STRING),filter_var($_POST['subject'],FILTER_SANITIZE_STRING),filter_var($_POST['message'],FILTER_SANITIZE_STRING));
            $messageSupport = Text('sentsuccesfully');
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo text('title_home');?></title>
    ...
    <link href="themes/css/headerhome.css" type="text/css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="themes/css/box_header_top.css">
    <link rel="stylesheet" href="themes/css/box_contact.css">


    <!-- seo -->
    <link rel="canonical" href="<?= $_SERVER['SERVER_NAME']?>" />
    <meta name="author" content="Hossame El Bezzari">
    <meta name="description" content="si vous êtes à la recherche d'un professeur qui vous aidera à réussir votre parcours scolaire,nous sommes là pour vous faciliter le chemin">
    <meta name="keywords" content="school,high school,back to school,think school case study,study,study with me,study tips,study hacks for school,how to study after school,how to study,think school,study motivation,back to school story,school tips,think school business,study skills,how to study effectively,study methods,study hacks,study techniques,study routine high school,international school,school story,study art without art school,back to school shopping,school vlog ,HTML, CSS, JavaScript">
    ...
    <meta property="og:title" content="AlloMyProf - Trouvez votre professeur préféré" />
    <meta property="og:description" content="si vous êtes à la recherche d'un professeur qui vous aidera à réussir votre parcours scolaire,nous sommes là pour vous faciliter le chemin" />
    <meta property="og:image" content="http://<?= $_SERVER['SERVER_NAME']?>/assets/images/material/headerSite.png" />
...
<body>
	...
	<div class="container">
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6"><?php echo text('header1');?>
				...
				<!-- Content -->
				<p class="my-4 lead"><?php echo text('header2');?></p>
				
				<form class="BoxRecherche" id="BoxRecherche" method="get" action="recherche">
                    <select name="ville" id="ville" class="inputBoxReche">
                    <?php
                        foreach(GetAllVille() as $allVille){ ?>
                            <option class="inputBoxReche" value="<?php echo $allVille['ville'];?>"><?php echo $allVille['ville'];?></option>
                        <?php }
                    ?>
                    </select>

                    <select name="matiere" id="matiere" class="inputBoxReche">
                    <?php
                        ...
                        <?php foreach(GetMatiereGroup($grouptype['typematiere']) as $groupmatiere){ ?>
                            <option value="volvo"><?php echo $groupmatiere['matiere'];?></option>
                            <?php } ?>
                    ...
                    <input hidden type="text" name="nomprof" class="">
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				...
				<div class="position-relative">
					<img src="assets\images\material\07.png" alt="">
				</div>
			</div>
			<!-- Right content END -->
		</div>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
                            ...
                            <div class="ms-4 h6 fw-normal mb-0">
                                <div class="d-flex">
                                    <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="200" data-purecounter-delay="200" data-purecounter-duration="0"><?= formatMillion(CountAccountComplait()) ?></h5>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
                            ...
                            <div class="ms-4 h6 fw-normal mb-0">
                                <div class="d-flex">
                                    <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="60" data-purecounter-delay="200" data-purecounter-duration="0"><?= formatMillion(CountContacterWhatsapp()) ?></h5>
                                    <span class="mb-0 h5">+</span>
                                </div>
    ...
    <!-- <section class="header">
        <div class="row justify-content-center">
            <div class="col-8 head1">
                <h1 class="header_text"><?php echo text('header1');?></h1>
                <p class="header_text_p"><?php echo text('header2');?></p>
        ...
        <div class="row justify-content-center">
            <div class="col-10 ">
                <div class="BoxPeople">
                    <img id="p1" src="assets/images/material/people1.png" alt="" srcset="">
                    <img id="p2" src="assets/images/material/people2.png" alt="" srcset="">
                    <img id="p3"src="assets/images/material/people3.png" alt="" srcset="">
        ...
        <section class="header2">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-sm-12 col-md-4">
                    <h2 class="titleHeader2"><?php echo text('header3');?></h2>
                    <p class="paraHeader2"><?php echo text('header_3');?></p>
                    <a class="linkHeader2" href="recherche"><?php echo text('getteacher');?> <i class="fal fa-angle-right"></i></a>

                </div>
                <div class="col-12 col-sm-12 col-md-6 DesignedBox">
                    <div class="boxTeacher">
                        <img class="imgTeacher" src="assets/images/material/learner-lesson.jpg" alt="">
                    </div>
                    <div class="MiniBoxTecher">
                        <img class="imgMiniTeacher" src="assets/images/material/ghjk.jpg" alt="">
                    </div>
                    <div class="MiniBoxTik">
                        <img class="imgMiniTikTeacher" src="assets/images/material/gvfi.png" alt="">
                    </div>
                    <div class="BoxAnnaly"></div>
                </div>
            </div>
        </section>
    
    <?php
            if(count(TopTeacher()) != 0){ ?>
            <section class="header3">
            <div class="row align-items-center justify-content-center">
                <?php
                $one = false;
                foreach(TopTeacher() as $topTeacher){ 
                    if(CheckIsInfoComplaite($topTeacher['id_teacher']) AND $one == false){
                        $one = true;
                    ?>
                    <div class="col-12 col-sm-10 col-md-10" id="topTeacher">
                        <div class="topTHeader4">
                            <img class="covertHeader4" src="assets/images/material/cheerful-teen-girl-student-with-classmates.jpg" alt="top tacher" />
                            <div class="boxTopheader4 row">
                                <div class="INfoHeader4 col-12 col-sm-12 col-md-8 mb-2">
                                    <div>
                                        <img class="ImgAccHeader" src="assets/upload/profiles/<?php echo GetProfileImage($topTeacher['id_teacher']);?>" alt="">
                                    </div>
                                    <div >
                                        <h4><?php echo strtoupper(GetInfoTeacher($topTeacher['id_teacher'])['fullname']);?></h4>
                                        <p><?php echo GetInfoTeacher($topTeacher['id_teacher'])['tel']?></p>
                                    </div>
                                </div>
                                <div class="BtnInfoHeader4 col-12 col-sm-12 col-md-4">
                                    <a target="blank" href="includes/redirect/Clicked_teacher?phone=<?php echo GetInfoTeacher($topTeacher['id_teacher'])['tel']?>&teacher=<?php echo $topTeacher['id_teacher'];?>">Contacter Prof</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <?php
    if(count(GetTopTeacher()) > 0){ ?>
    <div class="container">
        <section class="header3">

            <div class="row justify-content-center">
                <div class="col-12">
                <div id="BoxTypeProperty">
                    <div class="BoxTitleTypeProperty"><?php echo text('topteacher');?></div>
                    <div class="ContentTypeProperty">
                        <div>
                            <div class="btnLeft" id="btnLeft" style="display: none;">
                                <i class="fas fa-arrow-circle-left"></i>
                                </div>
                            </div>
                            <div>
                                <div class="btnRight" id="btnRight">
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                            </div>
                            
                            <div class="LoopTypeProperty" id="LoopTypeProperty">
                                <?php
                                    foreach(GetTopTeacher() as $loopTypeProperty){ ?>
                                        <a class="Elelink" href="teacher?id=<?php echo $loopTypeProperty['id_teacher'];?>">
                                            <div>
                                                <img class="ImageTypeProperty" src="assets/upload/profiles/<?php echo $loopTypeProperty["src"];?>" alt="">
                                                <!-- <div style="background-image: url();" ></div> -->
                                                <div class="TypeDiVProperty">
                                                    <p class="TypePropertyTY"><?php echo strtoupper($loopTypeProperty["fullname"]);?></p></div>
                                            </div>
                                        </a>
                                    <?php }
                                ?>
    ...
    <?php
    if(count(GetVilleParCount()) > 0){ ?>    
    <div class="container">
        <section>
            <div class="row justify-content-center">
                <div class="col-12">
                    <div id="BoxCommandVille">
                        <div class="BoxTitleCommandVille"><?php echo text('teacherforville');?></div>
                        <div class="ContentCommandVille">
                            
                        <div style="position: relative;">
                            <div class="btnLeftCommandVille" id="btnLeftCommandVille" style="display: block;">
                                    <i class="fas fa-arrow-circle-left"></i>
                            </div>
                        </div>
                        <div style="position: relative;">
                            <div class="btnRightCommandVille" id="btnRightCommandVille">
                                <i class="fas fa-arrow-circle-right"></i>
                            </div>
                        </div>

                        <div class="LoopCommandVille" id="LoopCommandVille">
                        <?php
                            foreach(GetVilleParCount() as $loopVille){
                                if($loopVille['src'] != null){ ?>
                                <div>
                                    <div class="ImageCommandVille" style="background-image: url(assets/images/material/ville/<?php echo $loopVille['src'];?>);"></div>
                                        <div class="CommandVilleDiV">
                                            <p class="CommandVilleTY"><?php echo $loopVille['ville'];?></p>
                                            <p class="detaillCommandVille"><?php echo $loopVille['count'] .' '. text('properties');?></p>
                                        </div>
                                    </div>
                            <?php }else{ ?>
                                    <div>
                                        <div class="ImageCommandVille" style="background-image: url(assets/images/material/ville/ville_unkown.jpg);"></div>
                                        <div class="CommandVilleDiV">
                                            <p class="CommandVilleTY"><?php echo $loopVille['ville'];?></p>
                                            <p class="detaillCommandVille"><?php echo $loopVille['count'] .' '. text('properties');?></p>
                                        </div>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="wrapper img" style="background-image: url(assets/images/material/laptop-2557571_1920.jpg);">
                    <div class="row">
                        <div class="col-md-9 col-lg-7">
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                <h3 class="mb-4"><?= Text('Contactus') ?></h3>
                                <div id="form-message-warning" class="mb-4"></div> 
                                <?php if(!empty($messageSupport)){ ?>
                                    <div id="form-message-success" style="display: block;"  class="mb-4">
                                    <?php echo $messageSupport; ?>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="label" for="name"><?= Text('FULLNAME') ?></label>
                                                <input type="text" class="form-control" name="name" id="name" placeholder="<?= Text('FULLNAME') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                <label class="label" for="email"><?= Text('EMAILADDRESS') ?></label>
                                                <input type="email" class="form-control" name="email" id="email" placeholder="<?= Text('EMAILADDRESS') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="label" for="subject"><?= Text('SUBJECT') ?></label>
                                                <input type="text" class="form-control" name="subject" id="subject" placeholder="<?= Text('SUBJECT') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="label" for="#"><?= Text('MESSAGE') ?></label>
                                                <textarea name="message" class="form-control" id="message" cols="30" rows="4" placeholder="<?= Text('MESSAGE') ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="submit" name="btncontact" value="<?= Text('SendMessage') ?>" class="btn btn-primary">
    ...
    <!-- jquery -->
    <script src="themes/plugin/jquery/jquery.js"></script>
    <script src="themes/js/resize_nav.js"></script>
