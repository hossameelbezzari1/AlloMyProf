...
<body>
        ...
        <section class="header2">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-sm-12 col-md-4">
                    ...
                    <a class="linkHeader2" href="recherche"><?php echo text('geteacher');?> <i class="fal fa-angle-right"></i></a>

                </div>
                <div class="col-12 col-sm-12 col-md-6 DesignedBox">
                    <div class="boxTeacher">
                        <img class="imgTeacher" src="assets/images/material/teacher.jpg" alt="">
                    </div>
                ...
                foreach(TopTeacher() as $topTeacher){ 
                    ...
                    <div class="col-12 col-sm-10 col-md-10" id="topTeacher">
                        <div class="topTHeader4">
                            <img class="covertHeader4" src="assets/images/material/cover_header.jpg" alt="top tacher" />
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="wrapper img" style="background-image: url(assets/images/material/img.jpg);">
                    <div class="row">
